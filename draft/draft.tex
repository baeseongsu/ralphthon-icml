...
The deployment artifact freezes P2 at \path{skills/auto-research/assets/review-optimization/smoke-prompt-calibration-v3.md} and pairs it with \path{generated-review.schema.json}. Under \path{skills/auto-research/scripts/}, \path{review_prompt_codex.py} implements inference; adjacent \path{review_prompt_*} scripts implement dataset freezing, batching, scoring, reflection, selection, and privacy-aware tracking. The deployment manifest records prompt and schema hashes. P3 and P4 remain opt-in experimental prompts.
